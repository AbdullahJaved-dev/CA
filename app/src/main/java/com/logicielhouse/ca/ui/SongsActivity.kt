...
class SongsActivity : AppCompatActivity(), SongsAdapter.SongsAdapterClickListeners,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar?.title = getString(R.string.songs)
        ...
        rvSongs.apply {
            ...
            layoutManager = LinearLayoutManager(this@SongsActivity, RecyclerView.VERTICAL, false)
        }
    ...
    private fun buildMediaSource(uri: Uri): MediaSource? {
        val dataSourceFactory: DataSource.Factory =
            DefaultDataSourceFactory(this, "exoplayer-driver", bandwidthMeter)
    ...
    override fun onPlayerError(error: ExoPlaybackException?) {
        ...
        if (audioPlayer.visibility == View.VISIBLE) {
            Toast.makeText(this, "" + error.sourceException.message, Toast.LENGTH_SHORT)
                .show()
        }
    }
